    ...
    return (
        <section className='flex flex-col items-center mt-10 mb-44'>
            <div className="w-9/12 max-w-screen-xl">
                ...
                <p className="font-light text-xl text-center mt-10 mb-8">Welcome to a world of wanderlust and endless horizons! Embark on a journey with our travel page, where every image tells a story and every weather description paints a vivid picture of adventure. Discover the allure of diverse destinations through a captivating collection of images that showcase the beauty of each place in every season.</p>
